...
public class ModItems {
    ...
    public static final List<BaseItem> COLOR_PICKERS = RegisterUtil.registerColorItems(dyeColor -> new ColorPicker(new FabricItemSettings().maxCount(1).maxDamage(64), dyeColor,"color_picker"), TOOL_GROUP);
    ...
    public static final List<BaseItem> SPRAY_GUNS = RegisterUtil.registerColorItems(dyeColor -> new SprayGun(new FabricItemSettings().maxCount(1).maxDamage(64), dyeColor,"spray_gun"), TOOL_GROUP);
    public static final BaseItem EMPTY_BRUSH = register(new BaseItem(new FabricItemSettings().maxCount(1), "empty_brush"), TOOL_GROUP);
    public static final List<BaseItem> BRUSHS = RegisterUtil.registerColorItems(dyeColor -> new Brush(new FabricItemSettings().maxCount(1).maxDamage(128), dyeColor,"brush"), TOOL_GROUP);
    ...
    public static final List<BaseItem> COLOR_WATER_BALLOONS = RegisterUtil.registerColorItems(dyeColor -> new ColorWaterBalloon(new FabricItemSettings().maxCount(64), dyeColor,"color_water_balloon"), TOOL_GROUP);
    ...
    public static final List<BaseItem> WALL_GUNS = RegisterUtil.registerColorItems(dyeColor -> new WallGun(new FabricItemSettings().maxCount(1).maxDamage(9), dyeColor,"wall_gun"), TOOL_GROUP);
    public static final List<BaseItem> WALL_SHELLS = RegisterUtil.registerColorItems(dyeColor -> new WallShell(new FabricItemSettings().maxCount(64), dyeColor,"wall_shell"), TOOL_GROUP);
    ...
    public static final List<BaseItem> COLOR_SCATTER_COLOR_GUNS = RegisterUtil.registerColorItems(dyeColor -> new ColorScatterColorGun(new FabricItemSettings().maxCount(1), dyeColor,"color_scatter_color_gun"), TOOL_GROUP);
    public static final List<BaseItem> PAINT_SMOKE_BOMBS = RegisterUtil.registerColorItems(dyeColor -> new PaintSmokeBomb(new FabricItemSettings().maxCount(8), dyeColor,"paint_smoke_bomb"), TOOL_GROUP);
    public static final BaseItem SIGNAL_GUN = register(new SignalGun(new FabricItemSettings().maxCount(1), "signal_gun"), TOOL_GROUP);
    public static final List<BaseItem> SIGNAL_SHELLS = RegisterUtil.registerColorItems(dyeColor -> new SignalShell(new FabricItemSettings().maxCount(16), dyeColor,"signal_shell"), TOOL_GROUP);
